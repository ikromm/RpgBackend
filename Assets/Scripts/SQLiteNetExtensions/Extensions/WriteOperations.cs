...
namespace SQLiteNetExtensions.Extensions
{
    public static class WriteOperations
    {
        ...
        static void InsertAllWithChildrenRecursive(this SQLiteConnection conn, IEnumerable elements, bool replace, bool recursive, HashSet<object> objectCache = null)
        {
            if (elements == null)
                return;
        ...
        static void InsertWithChildrenRecursive(this SQLiteConnection conn, object element, bool replace, bool recursive, HashSet<object> objectCache = null)
        {
            objectCache = objectCache ?? new HashSet<object>();
        ...
        static void InsertChildrenRecursive(this SQLiteConnection conn, object element, bool replace, bool recursive, HashSet<object> objectCache = null)
        {
            if (element == null)
                return;
        ...
        static void InsertValue(this SQLiteConnection conn, object value, bool replace, bool recursive, HashSet<object> objectCache)
        {
            if (value == null)
                return;
        ...
        static IEnumerable InsertElements(this SQLiteConnection conn, IEnumerable elements, bool replace, HashSet<object> objectCache)
        {
            if (elements == null)
        ...
        static void InsertElement(this SQLiteConnection conn, object element, bool replace, HashSet<object> objectCache)
        {
        ...
        static void InsertElement(this SQLiteConnection conn, object element, bool replace, PropertyInfo primaryKeyProperty, bool isAutoIncrementPrimaryKey, HashSet<object> objectCache)
        {
        ...
        static void DeleteAllRecursive(this SQLiteConnection conn, IEnumerable elements, bool recursive, HashSet<object> objectCache = null) {
            if (elements == null)
                return;
        ...
        static void DeleteValueRecursive(this SQLiteConnection conn, object value, bool recursive, HashSet<object> objectCache) {
            if (value == null)
                return;
        ...
        private static void UpdateOneToManyInverseForeignKey(this SQLiteConnection conn, object element, PropertyInfo relationshipProperty)
        {
            ...
            var childrenPlaceHolders = string.Join(",", Enumerable.Repeat("?", childrenKeyList.Count).ToArray());
        ...
        private static void UpdateManyToManyForeignKeys(this SQLiteConnection conn, object element, PropertyInfo relationshipProperty)
        {
            ...
            var childrenPlaceHolders = string.Join(",", Enumerable.Repeat("?", childKeyList.Count).ToArray());
        ...
        private static void DeleteAllIds(this SQLiteConnection conn, object[] primaryKeyValues, string entityName, string primaryKeyName) {
            ...
            if (primaryKeyValues.Length <= limit) {
                var placeholdersString = string.Join(",", Enumerable.Repeat("?", primaryKeyValues.Length).ToArray());
